			...
			<div class="row text-center">
				<div class="col my-auto">
					<div class="product-buttons">
						...
						<a  class="compare" href="<?php echo site_url();?>/?action=yith-woocompare-add-product&amp;id=<?php echo get_the_ID();?>"  data-product_id="<?php echo get_the_ID();?>" rel="nofollow"><i class="fa fa-plus"></i></a>
